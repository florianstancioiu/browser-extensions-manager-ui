...
const Extension = ({
  ...
  return (
    <div className="fm:mb-0 fm:grid fm:justify-between dark:bg-dark-bg dark:border-main-border-dark bg-white-bg mb-[15px] border-main-border border-[1px] rounded-[10px] p-[18px]">
